...
public class RecipeService {
    ...
    public static class getRecipesAsync extends AsyncTask<String, String, ArrayList<Recipe>> {
        public ArrayList<Recipe> doInBackground(String... args) {
            ...
            try {
                ...
                URL url = new URL(g.getEmail()+"/Api/Recipe/GetRecipesFromUser");
    ...
    public static class getByIdAsync extends AsyncTask<String, String, Recipe> {
        public Recipe doInBackground(String... id) {
            Globals g = Globals.getInstance();
            try {
                URL url = new URL("http://drshopperapi.azurewebsites.net/Api/Recipe/Get?id=" + id[0]);
    ...
    public static class createNewRecipe extends AsyncTask<Object, Bitmap, Boolean> {
        ...
        protected Boolean doInBackground(Object... params) {
            ...
            HttpPost httppost = new HttpPost("http://drshopperapi.azurewebsites.net/RecipeTwo/AddNewRecipe?recipename="+recipeName+"&description="+recipeDescription+"&instruction="+recipeInstruction+"&ingredientz="+addtoUrl);
            Globals g = Globals.getInstance();
            byte[] data = null;
            try {
    ...
    public static void deleteRecipe(int id){
        ...
        Globals g = Globals.getInstance();
        try {
            url = new URL("http://drshopperapi.azurewebsites.net/Api/Recipe/DeleteRecipe?recipeid=" +id);
    ...
    public static void setToggleFavorite(int id, boolean isFavorite){
        ...
        if(isFavorite){
            //Unfavorite
            httpPost = new HttpPost("http://drshopperapi.azurewebsites.net/Api/Recipe/PostFavoriteRecipeToUser?recipeid=" +id);
        }
        else{
            //Favorite
            httpPost = new HttpPost("http://drshopperapi.azurewebsites.net/Api/Recipe/PostFavoriteRecipeToUser?recipeid=" +id);
